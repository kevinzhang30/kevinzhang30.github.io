    ...
    <group>
      <Float speed={0.45} rotationIntensity={0.01} floatIntensity={0.05}>
        <group>
          ...
          <LightStrip position={[0, -3.05, 5.98]} scale={[8.2, 0.05, 0.05]} />
          <LightStrip position={[-7.2, -3.3, 5.95]} scale={[1.9, 0.05, 0.05]} intensity={1.4} />
          <LightStrip position={[7.2, -3.3, 5.95]} scale={[1.9, 0.05, 0.05]} intensity={1.4} />
          <LightStrip position={[-4.6, 0.45, 1.08]} scale={[0.05, 5.4, 0.05]} intensity={1.4} />
          <LightStrip position={[4.6, 0.45, 1.08]} scale={[0.05, 5.4, 0.05]} intensity={1.4} />

          <Screen position={[0, -3.15, 5.92]} rotation={[-0.73, 0, 0]} scale={[3.1, 0.85, 1]} />
          <Screen position={[-5.4, -3.25, 6.05]} rotation={[-0.85, 0.2, 0.18]} scale={[1.8, 0.72, 1]} color="#77ffd8" />
          <Screen position={[5.4, -3.25, 6.05]} rotation={[-0.85, -0.2, -0.18]} scale={[1.8, 0.72, 1]} color="#ff8d5f" />

          <ButtonArray origin={[-5.45, -3.95, 6.12]} rows={2} cols={4} spacing={0.34} color="#77ffd8" />
          <ButtonArray origin={[5.45, -3.95, 6.12]} rows={2} cols={4} spacing={0.34} color="#ff8d5f" />
          <ButtonArray origin={[0, -3.9, 6.05]} rows={2} cols={6} spacing={0.28} color="#58d7ff" />
          ...
          <pointLight position={[0, -3.4, 5.8]} intensity={7.5} distance={18} color="#24d7ff" />
          <pointLight position={[-5.25, -3.25, 5.9]} intensity={3.4} distance={8} color="#77ffd8" />
          <pointLight position={[5.25, -3.25, 5.9]} intensity={3.4} distance={8} color="#ff8d5f" />
        </group>
      </Float>
    </group>
  );
