...
export default function Satellite({
  ...
  useFrame((state) => {
    ...
    if (groupRef.current) {
      ...
      groupRef.current.position.y = destination.objectPosition[1] + Math.sin(t * 0.9 + 0.8) * 0.28;
      ...
      >
        ...
        <mesh position={[0, 0.3, 0]}>
          ...
          <meshStandardMaterial
            color="#121c30"
            emissive="#46e0b5"
            emissiveIntensity={isHovered || isActive ? 0.75 : 0.35}
            roughness={0.3}
            metalness={0.72}
          />
        </mesh>
          ...
          <group key={side} position={[side * 2.65, 0, 0]}>
            ...
            <mesh position={[side * 1.65, 0, 0]}>
              ...
              <meshStandardMaterial
                color="#0b2a4b"
                emissive="#46e0b5"
                emissiveIntensity={isHovered || isActive ? 0.55 : 0.2}
                roughness={0.38}
                metalness={0.62}
              />
            </mesh>
            <mesh position={[side * 1.65, 0, 0.05]}>
              ...
              <meshStandardMaterial
                color="#10263f"
                emissive="#58ffd2"
                emissiveIntensity={isHovered || isActive ? 0.28 : 0.1}
                roughness={0.24}
                metalness={0.55}
              />
            </mesh>
